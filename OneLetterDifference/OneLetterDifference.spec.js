const { oneLetterDifference } = require('./OneLetterDifference');

describe('One Letter Difference Testing Suite', () => {
  it('should return a string', () => {
    expect(typeof oneLetterDifference(['ab', 'ac'])).toBe('string');
  });
  it('should return `qwety`', () => {
    expect(
      oneLetterDifference([
        'qwerty',
        'qwedty',
  ...
  it('should return ', () => {
    expect(oneLetterDifference(arr)).toBe('qysdtrkloagnfozuwujmhrbvx');
  });
});
